...
public class Practice4 {
	...
	//// #### DECRYPTION ####
		...
		String mrt = decryptSentence("sadbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbdfgndfgnsdgsdndfnfgngdfhmfghm");
		...
		System.out.println(decryptSentence("sadbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbdfgndfgnsdgsdndfnfgngdfhmfghm"));
		
		
		System.out.println(decryptWord("murat"));
	}
